...
const cat_return_1 = require("./dto/cat.return");
...
], CatsResolver.prototype, "hello123", null);
__decorate([
    (0, graphql_1.Query)(() => [cat_return_1.CatReturn]),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], CatsResolver.prototype, "cats", null);
__decorate([
    (0, graphql_1.Mutation)(() => cat_return_1.CatReturn),
